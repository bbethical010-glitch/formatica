              ...
              children: [
                ...
                Text(
                  ...
                  style: AppTextStyles.studioLabel.copyWith(
                    color: AppColors.imageCyan.withOpacity(0.8),
                  ),
                ),
                  ...
                  if (_selectedFormat != null) ...[
                    ...
                    if (showQualitySlider) ...[
                      ...
                      LiquidGlassContainer(
                        ...
                        color: AppColors.imageCyan.withOpacity(0.05),
                        child: Center(
                          child: Text(
                            'LOSSLESS PRECISION ENGAGED',
                            style: AppTextStyles.studioLabel.copyWith(
                              color: AppColors.imageCyan.withOpacity(0.6),
                              fontSize: 10,
                            ),
                          ),
                        ),
      ...
      child: LiquidGlassContainer(
        ...
        child: _filePath == null
            ...
            : Container(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.image_rounded, color: AppColors.imageCyan, size: 32),
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          ...
          child: LiquidGlassContainer(
            ...
            color: isSelected 
              ? AppColors.imageCyan.withOpacity(0.15) 
              : isDark ? Colors.white.withOpacity(0.04) : Colors.black.withOpacity(0.02),
            borderColor: isSelected 
              ? AppColors.imageCyan.withOpacity(0.4) 
            ...
            child: Center(
              child: Text(
                ...
                style: AppTextStyles.studioLabel.copyWith(
                  ...
                  color: isSelected 
                    ? (isDark ? Colors.white : AppColors.imageCyan) 
            ...
            child: FractionallySizedBox(
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: AppColors.imageCyan.withOpacity(0.3),
                      blurRadius: 10,
                    ),
                  ],
                ),
    ...
    return LiquidGlassContainer(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'The visual stream has been correctly re-encoded to the target optics format.',
            ...
            children: [
              ...
              Expanded(
                child: MediaPillButton(
                  label: 'ANOTHER',
                  onTap: _resetForm,
                  accentColor: AppColors.imageCyan.withOpacity(0.4),
                ),
              ),
            ],
          ),
        ...
        return Column(
          ...
          children: [
            ...
            LiquidGlassContainer(
              ...
              child: Row(
                children: [
                  const Icon(Icons.folder_open, size: 18, color: AppColors.imageCyan),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Text(
    ...
    showDialog(
      ...
      builder: (ctx) => BackdropFilter(
        ...
        child: AlertDialog(
          ...
          content: Text(
            'ABORT THE ACTIVE VISUAL SYNTHESIS PROCESS?',
            style: AppTextStyles.studioLabel.copyWith(
